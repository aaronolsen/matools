readROISeries <- function(file, name.min.char = 5){
	...
	# Set locale for reading characters
	...
	repl_char <- c('\001','\002','\003','\004','\005','\006','\007','\016','\017','\018',
		'\019','\020','\021','\022','\023','\024','\025','\026','\027','\028','\029','\030',
		'\031','\032','\033','\034','\035','\036','\037','\038','\039','\040','\041','\042',
		'\043','\044','\045','\046','\047','\048','\049','\177','\201','\202','\203','\204',
		'\205','\206','\210','\212','\216','\220','\222','\223','\224','\225','\226','\231',
		'\234','\235','\236','\237','\241','\243','\246','\251','\253','\254','\255','\270',
		'\271','\273','\277','\301','\302','\304','\305','\306','\307','\314','\316','\317',
		'\320','\321','\323','\325','\330','\332','\334','\341','\344','\346','\350','\352',
		'\353','\354','\357','\360','\361','\366','\367','\372','\373','\375','\376','\377',
		'f88B')
	...
	char_sub <- gsub(repl_char_useBytes, '', char_sub)
